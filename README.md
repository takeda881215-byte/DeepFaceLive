...
`opencv-contrib-python` already ships with the core OpenCV functionality plus the contrib modules. If you do not need GUI window support and want a smaller footprint, substitute it with `opencv-contrib-python-headless` at the same version.
